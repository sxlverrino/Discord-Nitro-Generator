...
class Console():        
    def ui(self):
        os.system(f'cls && title [DNG] Discord Nitro Generator  ^|  Press Ctrl+C to Close' if os.name == "nt" else "clear")
        print(center(f"""\n\n
██████╗ ███╗   ██╗ ██████╗ 
    ...
    def run(self):
        ...
        try:
            ...
            if req.status_code == 200:
                ...
                open('results/Discord_Nitro_Codes.txt', 'a+').write(self.code+"\n")
                try:
